...
appData.save.defaultDir = '/Volumes/MacHD/Links/Documents/MATLAB Data';%['F:\My Documents\Experimental\' datestr(now, 29)];%'C:\Documents and Settings\broot\Desktop\shimi';
...
appData.consts.cameras{appData.consts.cameraTypes.prosilica}.chipStart =145;%was 131 before hight calibration
...
appData.consts.cameras{appData.consts.cameraTypes.AMS}.dir = '/Volumes/MacHD/Links/Documents/MATLAB/imaging v4.6.4_AMS';
...
appData.consts.cameras{appData.consts.cameraTypes.AMS}.darkPicNo = 3;
