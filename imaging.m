...
% appData.ui.stFitResults = uicontrol(appData.ui.pFitResults, ...
%     'Style', 'text', ...
%     'String', 'Pic. No.:', ...
%     'Units', 'pixels', ...
%     'Position', [5 5 470 200], ...
%     'BackgroundColor', [0.8 0.8 0.8], ...
%     'HorizontalAlignment', 'left', ...
%     'FontSize', appData.consts.fontSize);
appData.ui.stFitResultsAtomNum = uicontrol(appData.ui.pFitResults, ...
    'Style', 'text', ...
    'String', 'Atoms Num: 12,345,678*10^9', ...
    'Units', 'pixels', ...
    'Position', [5 180 475 25], ...
    'BackgroundColor', [0.8 0.8 0.8], ...
    'HorizontalAlignment', 'left', ...
    'FontSize', appData.consts.fontSizeResultsLarge);
appData.ui.stFitResultsFitFunction = uicontrol(appData.ui.pFitResults, ...
    'Style', 'text', ...
    'String', {'Fit Function: '}, ...
    'Units', 'pixels', ...
    'Position', [5 130 475 45], ...
    'BackgroundColor', [0.8 0.8 0.8], ...
    'HorizontalAlignment', 'left', ...
    'FontSize', appData.consts.fontSizeResults);
appData.ui.stFitResults1 = uicontrol(appData.ui.pFitResults, ...
    'Style', 'text', ...
    'String', '', ...
    'Units', 'pixels', ...
    'Position', [5 5 200 120], ...
    'BackgroundColor', [0.8 0.8 0.8], ...
    'HorizontalAlignment', 'left', ...
    'FontSize', appData.consts.fontSizeResults);
appData.ui.stFitResults2 = uicontrol(appData.ui.pFitResults, ...
    'Style', 'text', ...
    'String', '', ...
    'Units', 'pixels', ...
    'Position', [210 5 270 120], ...
    'BackgroundColor', [0.8 0.8 0.8], ...
    'HorizontalAlignment', 'left', ...
    'FontSize', appData.consts.fontSizeResults);
...
%     dark = rot90( double(appData.data.camera.fileReadFunction(appData, appData.data.camera.darkPicNo)), ...
%         appData.data.camera.rotate / 90);
%     appData.data.dark = double(imread([appData.data.camera.dir appData.slash appData.data.camera.darkPicStr]));
...
%     appData.data.absorption = log( (back2 + (back2==0))./ (atoms2 + (atoms2==0))  );  % set all pixelvalues=0 to 1 and divide pics
    absorption = log( (back + 1)./ (atoms + 1)  );clc
...
function pbAnalyze_Callback(object, eventdata) %#ok<INUSD>
    appData = analyzeMeasurement(appData);
    return
